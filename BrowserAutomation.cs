...
public sealed class BrowserAutomation : IAsyncDisposable
{
    ...
    public BrowserAutomation(string browserType, bool headless)
    {
        _browserType = browserType;
        _headless = headless;
    }

    public async Task<string> ExecuteToolAsync(string toolName, JsonNode? arguments)
    {
...
#pragma warning restore CS0612 // Type or member is obsolete
    ...
    /// <summary>
    /// Gets the list of available tool definitions.
    /// </summary>
    public static List<object> GetToolDefinitions()
    {
        const string ElementDescription = "Human-readable element description used to obtain permission to interact with the element";
        const string RefDescription = "Exact target element reference from the page snapshot";
